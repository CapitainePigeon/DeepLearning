...
def plot_2d_latents(ax, qz, z, y):
    ...
    ax.scatter(z[:, 0], z[:, 1], color=colors, label=['a', 'b', 'c'])
...
def make_vae_plots(vae, x, y, outputs,outputs_matches, training_data, validation_data,validation_data_politic,validation_data_UK, tmp_img="tmp_vae_out.png", figsize=(9, 9)):
